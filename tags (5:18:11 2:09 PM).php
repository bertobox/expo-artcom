...
<style type="text/css" media="print">
	  ...
	  p, h2, h3 { orphans: 3; widows: 3; }
		...
		.tag{width: 3.75in;padding:0;margin: .5cm .3cm .5cm 0;clear:both;}
		.tag .left{float: left;width: .84in;}
			.folio{font-family: "mplus-1c-black", "m1cblack", Arial, sans-serif;font-size: 27pt;line-height: 1;margin: 0;letter-spacing: 0;}
			.qr{width: .84in;display: block;margin-top: 20.6pt;}
		.tag .right{float: left;width: 2.91in;text-align: right;}
			...
			.materia{font-family: "mplus-1c-regular", "m1cregular", Arial, sans-serif;text-transform: uppercase;font-size: 9pt;margin:5pt 0 0;line-height: 20pt;}
			...
			*/
				...
				* html .clearfix {
				...
				.page{
					...
					.page:first{display:none;}
					.tl{border:1px solid #CBCBCB;border-width:0px 0px 0px 1px;position:absolute;top:0px;left:0px;height:10px;width:10px;}
					.tr{border:1px solid #CBCBCB;border-width:0px 1px 0px 0px;position:absolute;top:0px;right:0px;height:10px;width:10px;}
					.bl{border:1px solid #CBCBCB;border-width:0px 0px 1px 0px;position:absolute;bottom:0px;left:0px;height:10px;width:10px;}
					.br{border:1px solid #CBCBCB;border-width:0px 1px 1px 0px;position:absolute;bottom:0px;right:0px;height:10px;width:10px;}
			/*	.column{float: left;}*/
			/*	.page-break  { display:none; }*/
				.clr{clear: both;}
				.break{-webkit-column-break-before:always;
				    -moz-column-break-before:always;
				    column-break-before:always;}
				.tag{position:relative;width: 3.25in;/*19.125em · 306px · 4.25in */padding:.25in .25in .0in .25in ;/*background-color: lightgreen;*/}
				.tag .left{float: left;width: .84in;/*background-color: pink;*/}
				.folio{font-family:"m1cblack", Arial, sans-serif;font-size: 27pt;line-height: 1;margin: 0;letter-spacing: 0;}
				.qr table{display: block;margin-top: 20.6pt;}
				/*.qr{width: 20px;}*/
				...
				.name{font-family: "DekarRegular", Arial, sans-serif;font-size: 16.5pt;line-height: 20pt;margin:8pt 0 0;height: 39pt;}
				.materia{font-family: "m1cregular", Arial, sans-serif;text-transform: uppercase;font-size: 9pt;margin:5pt 0 0;line-height: 20pt;color:#666;}
				.specs{font-family:"m1cheavy", Arial, sans-serif;font-size: 9pt;line-height: 20pt;margin: 0;height:58pt;}
				.tecnica{font-family:"m1clight", Arial, sans-serif;}
				.especificaciones{}
	}
</style>
